                    ...
                    <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                        <div class="flex justify-between">
                            <div>
                                ...
                                <p class="font-semibold text-lg">{{ $transaction->flight->segments->first()->airport->name}} 
                                    {{ $transaction->flight->segments->first()->airport->iata_code}}</p>
                            </div>
                            <div class="text-end">
                                <p class="text-sm text-garuda-grey">Arrival</p>
                                <p class="font-semibold text-lg">{{ $transaction->flight->segments->last()->airport->name}} 
                                    {{ $transaction->flight->segments->last()->airport->iata_code}}</p>
                            </div>
                        </div>
                        <div class="flex justify-between">
                            <div>
                                <p class="text-sm text-garuda-grey">Date</p>
                                <p class="font-semibold text-lg">{{$transaction->flight->segments->first()->time->format('d F y')}}4</p>
                            </div>
                            <div class="text-end">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-[10px]">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-garuda-grey mt-[2px]">{{$transaction->flight->segments->first()->time->format('H:i') . ' - ' . $transaction->flight->segments->last()->time->format('H:i')}}</p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex flex-col gap-[2px] items-center justify-center">
                                ...
                                <div class="flex items-center gap-[6px]">
                                    <p class="font-semibold">{{$transaction->flight->segments->first()->airport->iata_code}}</p>
                                    ...
                                    @endif
                                    <p class="font-semibold">{{$transaction->flight->segments->last()->airport->iata_code}}</p>
                                </div>
                                @if($transaction->flight->segments->count() > 2)
                            ...
                            <p class="font-semibold text-garuda-green text-center">{{'Rp ' . number_format($transaction->flight->classes->first()->price, 0, ',', '.')}}</p>
                        </div>
