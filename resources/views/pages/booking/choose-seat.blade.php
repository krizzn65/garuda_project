            ...
            <div id="Plane" class="relative flex w-[558px] shrink-0 mt-[30px] mx-auto">
                ...
                <div class="relative flex flex-col justify-end">
                    ...
                    <form action="{{route('booking.confirmSeat', $flight->flight_number)}}" method="POST" class="relative px-[56px] pb-[60px]">
                        ...
                        class="flex flex-wrap w-full gap-y-8 @if ($tier->class_type == 'business') gap-x10 px-[33px] @else gap-x-[14px] @endif">
                            @foreach ($flight->seats->where('class_type', $tier->class_type) as $seat)
                                ...
                                data-seat="{{ $seat->name }}" data-seat-id="{{ $seat->id }}" data-seat-price="{{ $seat->price }}">
                                ...
                                <input type="checkbox" name="seat" 
                                    ...
                                    <img src="{{asset('assets/images/icons/seat.svg')}}" alt="seat"
                                    ...
                                    <img src="{{asset('assets/images/icons/seat-choosed.svg')}}" alt="seat"
                                    ...
                                    <img src="{{asset('assets/images/icons/seat-disabled.svg')}}" alt="seat"
                                    class="absolute w-full h-full object-contain opacity-0 group-has-[:disabled]:opacity-100 transition-all duration-300"
                                    alt="seat"/>

                                    <p class="realtive flex items-center justify-center h-full w-full pb-[8.25px] font-semibold text-[16.5px] leading-[24.75px] text-premiere-black group-has-[:checked]:text-white">
                                        {{$seat->name}}
                                    </p>
                                </label>
                            @endforeach
