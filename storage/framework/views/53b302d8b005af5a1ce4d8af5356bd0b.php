<div>
    ...
    >
        ...
        <div class="fi-sidebar-header-ctn">
            ...
            >
                <?php if((! $hasTopbar) && $isSidebarCollapsibleOnDesktop): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1286912653-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
        ...
        <?php if($shouldRenderFooter): ?>
            <div class="fi-sidebar-footer">
                <?php if($hasDatabaseNotificationsInSidebar): ?>
                    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1286912653-1', $__slots ?? [], get_defined_vars());
...
<?php /**PATH D:\Aplikasi\garuda-project\vendor\filament\filament\resources\views\livewire\sidebar.blade.php ENDPATH**/ ?>