...
<div id="Background" class="absolute top-0 w-full h-[810px] bg-[linear-gradient(180deg,#85C8FF_0%,#D4D1FE_47.05%,#F3F6FD_100%)]">
        <img src="<?php echo e(asset('assets/images/backgrounds/Jumbo Jet Sky (1) 1.png')); ?>" class="absolute right-0 top-[147px] object-contain max-h-[481px]" alt="background image">
    </div>
                ...
                <div id="Booking-details" class="flex flex-col rounded-[20px] p-5 gap-5 bg-white overflow-hidden">
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center rounded-full border border-garuda-black py-3 px-5 gap-[10px] focus-within:border-[#0068FF] transition-all duration-300">
                            <img src="<?php echo e(asset('assets/images/icons/note-favorite-black.svg')); ?>" class="w-5 flex shrink-0" alt="icon">
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center rounded-full border border-garuda-black py-3 px-5 gap-[10px] focus-within:border-[#0068FF] transition-all duration-300">
                            <img src="<?php echo e(asset('assets/images/icons/call-black.svg')); ?>" class="w-5 flex shrink-0" alt="icon">
                    ...
                    <a href="#" class="flex justify-center w-full rounded-full py-3 px-5 text-center border border-garuda-black gap-[10px]">
                        <img src="<?php echo e(asset('assets/images/icons/call-calling-black.svg')); ?>" class="w-5 flex shrink-0" alt="icon">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Aplikasi\garuda-project\resources\views\pages\booking\check-booking.blade.php ENDPATH**/ ?>