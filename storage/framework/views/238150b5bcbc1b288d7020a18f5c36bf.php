...
<?php endif; ?>
                            ...
                            <div
                                class="fi-fo-file-upload-editor-control-panel-group"
                            >
                                <?php $__currentLoopData = $getImageEditorActions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupedActions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH D:\Aplikasi\garuda-project\vendor\filament\forms\resources\views\components\file-upload.blade.php ENDPATH**/ ?>