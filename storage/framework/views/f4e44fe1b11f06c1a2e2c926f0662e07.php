...
<?php endif; ?>
        ...
        <?php $__currentLoopData = $getChildSchema()->getComponents(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($tabVisibilityJs): ?>
                <div x-show="<?php echo $tabVisibilityJs; ?>" x-cloak>
                    <?php echo e($tab); ?>
...
<?php endif; ?>
<?php /**PATH D:\Aplikasi\garuda-project\vendor\filament\schemas\resources\views\components\tabs.blade.php ENDPATH**/ ?>