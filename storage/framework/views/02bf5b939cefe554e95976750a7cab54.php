...
<?php if($hasPageSummary): ?>
    <tr class="fi-ta-row fi-ta-summary-header-row fi-striped">
        <?php if($placeholderColumns && $actions && in_array($actionsPosition, [RecordActionsPosition::BeforeCells, RecordActionsPosition::BeforeColumns])): ?>
            <td></td>
        <?php endif; ?>
        ...
        <?php if($placeholderColumns && $actions && in_array($actionsPosition, [RecordActionsPosition::AfterColumns, RecordActionsPosition::AfterCells])): ?>
            <td></td>
        <?php endif; ?>
...
<?php unset($__componentOriginala3ad14087ab6b316cf1e1d1a634acbeb); ?>
<?php endif; ?>
<?php /**PATH D:\Aplikasi\garuda-project\vendor\filament\tables\resources\views\components\summary\index.blade.php ENDPATH**/ ?>