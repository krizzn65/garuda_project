...
>
    ...
    <?php if($aboveContentContainer = $getChildSchema($schemaComponent::ABOVE_CONTENT_SCHEMA_KEY)?->toHtmlString()): ?>
...
<?php endif; ?>
    ...
    <?php if($belowContentContainer = $getChildSchema($schemaComponent::BELOW_CONTENT_SCHEMA_KEY)?->toHtmlString()): ?>
        <?php echo e($belowContentContainer); ?>

    <?php endif; ?>
</div>
<?php /**PATH D:\Aplikasi\garuda-project\vendor\filament\schemas\resources\views\components\actions.blade.php ENDPATH**/ ?>