...
<?php endif; ?>
        ...
        <?php else: ?>
            ...
            <?php if(filled($headerActions) || $breadcrumbs || filled($heading) || filled($subheading)): ?>
...
<?php endif; ?>
    ...
    <?php if(method_exists($this, 'hasUnsavedDataChangesAlert') && $this->hasUnsavedDataChangesAlert()): ?>
        <?php if(\Filament\Support\Facades\FilamentView::hasSpaMode()): ?>
                <?php
        $__scriptKey = '2397800775-0';
        ob_start();
    ?>
                <script>
    ...
    <?php if((! app()->hasDebugModeEnabled()) && $this->hasErrorNotifications()): ?>
            <?php
        $__scriptKey = '2397800775-2';
        ob_start();
    ?>
            <script>
...
<?php /**PATH D:\Aplikasi\garuda-project\vendor\filament\filament\resources\views\components\page\index.blade.php ENDPATH**/ ?>