...
>
    ...
    >
        <?php if($hasFiltersBeforeContent): ?>
            <div
            ...
            >
                ...
                <?php elseif(($heading || $description || $headerActions) && ! $isReordering): ?>
                    ...
                    >
                        ...
                        <?php if((! $isReordering) && $headerActions): ?>
                            <div
                                class="fi-ta-actions fi-align-start fi-wrapped"
                            >
                                <?php $__currentLoopData = $headerActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo e($action); ?>
                ...
                >
                    ...
                    <div class="fi-ta-actions fi-align-start fi-wrapped">
                        ...
                        <?php if((! $isReordering) && count($toolbarActions)): ?>
                            <?php $__currentLoopData = $toolbarActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo e($action); ?>
...
<?php $component->withAttributes(['x-model' => 'group','x-on:change' => 'resetCollapsedGroups()']); ?>
                                                    ...
                                                    <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option
...
<?php endif; ?>
                                        ...
                                        <?php if(! $isGroupingDirectionSettingHidden): ?>
...
<?php endif; ?>
                                ...
                                <?php if(! $areGroupingSettingsInDropdownOnDesktop): ?>
                                    <div class="fi-ta-grouping-settings-fields">
                                        <label>
                                            <?php if (isset($component)) { $__componentOriginal505efd9768415fdb4543e8c564dad437 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal505efd9768415fdb4543e8c564dad437 = $attributes; } ?>
...
<?php endif; ?>
                    ...
                    <?php if($isGlobalSearchVisible || $hasFiltersTrigger || $hasColumnManagerDropdown): ?>
                        <div>
...
<?php endif; ?>
                            ...
                            <?php if($hasFiltersTrigger || $hasColumnManagerDropdown): ?>
                                <?php if($hasFiltersDialog): ?>
                                    <?php if(($filtersLayout === FiltersLayout::Modal) || $filtersTriggerAction->isModalSlideOver()): ?>
                                        <?php
...
<?php endif; ?>
            ...
            <?php if($filterIndicators): ?>
                <?php if(filled($filterIndicatorsView = FilamentView::renderHook(TablesRenderHook::FILTER_INDICATORS, scopes: static::class, data: ['filterIndicators' => $filterIndicators]))): ?>
                    ...
                    <div class="fi-ta-filter-indicators">
                        <div>
                            ...
                            <div class="fi-ta-filter-indicators-badges-ctn">
                                <?php $__currentLoopData = $filterIndicators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indicator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
...
<?php endif; ?>
                        ...
                        <?php if(collect($filterIndicators)->contains(fn (\Filament\Tables\Filters\Indicator $indicator): bool => $indicator->isRemovable())): ?>
                            <button
                                type="button"
                                x-tooltip="{
            ...
            <?php if(((! $content) && (! $hasColumnsLayout)) || ($records === null) || count($records)): ?>
                ...
                >
                    <?php if($hasContentLayout && ($records !== null) && count($records)): ?>
                        <?php if(! $isReordering): ?>
                            <?php
                            ...
                            <?php if(($isSelectionEnabled && ($maxSelectableRecords !== 1) && (! $isReordering) && (! $selectsGroupsOnly)) || count($sortableColumns)): ?>
                                <div class="fi-ta-content-header">
                                    <?php if($isSelectionEnabled && ($maxSelectableRecords !== 1) && (! $isReordering) && (! $selectsGroupsOnly)): ?>
                                        <input
                        ...
                        <?php else: ?>
                            ...
                            >
                                ...
                                <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if((string) $recordGroupTitle !== (string) $previousRecordGroupTitle): ?>
...
<?php endif; ?>
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                >
                                                    <?php if(filled($recordGroupLabel = ($group->isTitlePrefixedWithLabel() ? $group->getLabel() : null))): ?>
                                        ...
                                        <div class="fi-ta-record-content-ctn">
                                            <div>
                                                <?php if($recordUrl): ?>
                                                    ...
                                                    >
                                                        <?php $__currentLoopData = $columnsLayout; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $columnsLayoutComponent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if($recordActions && (! $isReordering)): ?>
                                                <div
                                                    class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                                ...
                                                >
                                                    <?php $__currentLoopData = $recordActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php echo e($action); ?>
...
<?php endif; ?>
                    ...
                    <?php elseif((! ($content || $hasColumnsLayout)) && ($records !== null)): ?>
                        <table class="fi-ta-table">
                            <thead>
                                    ...
                                    <tr class="fi-ta-table-head-groups-row">
                                        <?php if(count($records)): ?>
                                            <?php if($isReordering): ?>
                                                <th></th>
                                            <?php else: ?>
                                                <?php if(count($defaultRecordActions) && in_array($recordActionsPosition, [RecordActionsPosition::BeforeCells, RecordActionsPosition::BeforeColumns])): ?>
                                                    <th></th>
                                                <?php endif; ?>
                                ...
                                <tr>
                                    <?php if(count($records)): ?>
                                        ...
                                        <?php else: ?>
                                            <?php if(count($defaultRecordActions) && $recordActionsPosition === RecordActionsPosition::BeforeCells): ?>
                                                <?php if($recordActionsColumnLabel): ?>
                                                    <th
                                            ...
                                            <?php if($isSelectionEnabled && $recordCheckboxPosition === RecordCheckboxPosition::BeforeCells): ?>
                                                ...
                                                >
                                                    <?php if(($maxSelectableRecords !== 1) && (! $selectsGroupsOnly)): ?>
                                                        <input
                                                            aria-label="<?php echo e(__('filament-tables::table.fields.bulk_select_page.label')); ?>"
                                                            type="checkbox"
                                                            <?php if($isSelectionDisabled): ?>
                                    ...
                                    <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($hasHeaderCellRenderHook && filled($headerCellView = FilamentView::renderHook(TablesRenderHook::HEADER_CELL, scopes: static::class, data: [
                                                 'column' => $column,
                                                 'isReordering' => $isReordering,
                                             ]))): ?>
                            ...
                            <?php if($isColumnSearchVisible || count($records)): ?>
                                <tbody
                                    <?php if($isReorderable): ?>
                                        x-on:end.stop="
                                            $wire.reorderTable(
...
<?php endif; ?>
                            ...
                            <?php if(($records !== null) && count($records) && $contentFooter): ?>
                                <tfoot>
                                    <tr>
                                        <?php echo e($contentFooter->with([
                                                'columns' => $columns,
                ...
                <?php else: ?>
                    <div class="fi-ta-empty-state">
                        <div class="fi-ta-empty-state-content">
                            ...
                            <?php if(filled($emptyStateDescription = $getEmptyStateDescription())): ?>
                            ...
                            <?php if($emptyStateActions = array_filter(
                                ...
                                >
                                    <?php $__currentLoopData = $emptyStateActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php echo e($action); ?>
...
<?php /**PATH D:\Aplikasi\garuda-project\vendor\filament\tables\resources\views\index.blade.php ENDPATH**/ ?>