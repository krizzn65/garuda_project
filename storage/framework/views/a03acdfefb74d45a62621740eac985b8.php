...
<?php endif; ?>
        ...
        <?php if($hasTopNavigation || (! $hasNavigation)): ?>
            <?php if($hasTenancy && filament()->hasTenantMenu()): ?>
...
<?php endif; ?>
        ...
        >
            ...
            <?php if(filament()->isGlobalSearchEnabled() && filament()->getGlobalSearchPosition() === \Filament\Enums\GlobalSearchPosition::Topbar): ?>
                <?php
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1981467464-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1981467464-1', $__slots ?? [], get_defined_vars());
...
<?php /**PATH D:\Aplikasi\garuda-project\vendor\filament\filament\resources\views\livewire\topbar.blade.php ENDPATH**/ ?>