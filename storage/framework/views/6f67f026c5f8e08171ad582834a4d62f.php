...
>
    <?php if($hasHeader): ?>
        ...
        >
            ...
            <?php if(! is_slot_empty($afterHeader)): ?>
...
<?php endif; ?>
    ...
    <?php if((! is_slot_empty($slot)) || (! is_slot_empty($footer))): ?>
        <div
            <?php if($collapsible): ?>
...
<?php /**PATH D:\Aplikasi\garuda-project\vendor\filament\support\resources\views\components\section\index.blade.php ENDPATH**/ ?>